...
class TeamProfiles
{
	...
	public function admin_notice() {
		...
		$html .= '<strong>Co-worker Profiles</strong> needs the <a href="http://www.advancedcustomfields.com/" target="_blank">Advanced Custom Fields</a> plugin to work. Please <a href="' . $install_link . '">install it now</a>.';
		$html .= '</p></div>';
	...
	public function register_post_type() {
	   ...
	   // Labels
		$labels = array(
			'name' => _x("Co-Worker", "post type general name"),
			'singular_name' => _x("Co-Worker", "post type singular name"),
			'menu_name' => 'Co-Worker Profiles',
		...
		// Register post type
		register_post_type('co-worker' , array(
			'labels' => $labels,
			'public' => true,
			'has_archive' => false,
	...
	public function register_taxonomy() {
		...
		register_taxonomy( strtolower($singular), 'co-worker', array(
			'public' => true,
			'show_ui' => true,
